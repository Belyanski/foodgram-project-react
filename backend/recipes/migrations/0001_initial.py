# Generated by Django 3.2.3 on 2023-07-31 00:11
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(1, message='Выберете хотя бы 1 ингредиент.'), django.core.validators.MaxValueValidator(100, message='Максимальное количество ингредиента - 100.')], verbose_name='Количество')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cooking_time', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(1, message='Минимальное время приготовления 1 минута.'), django.core.validators.MaxValueValidator(1440, message='Максимальное время приготовления 1440 минут (1 день).')], verbose_name='Время приготовления')),
